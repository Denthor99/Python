...
# Las direcciones en memoria no son inmutables, ya que pueden ir cambiando cada vez que ejecutemos el programa, ya que la
# memoria RAM es una memoria de tipo volátil
print(id(x))
print(id(y))
print(id(tresVar))
